...
export default function Footer() {
  return (
    <footer className="fz-6-footer fz-7-footer fz-7-body" data-aos="fade-up">
        ...
        <div className="container">
          <div className="row gy-4 align-items-center">
            ...
            <div className="col-lg-4 order-0 order-lg-1 text-center">
              <a href="index.html">
                <img src={Logo7dark} alt="logo"/>
              </a>
            </div>

            <div className="col-lg-4 col-sm-6 order-2 text-end">
              <img src={Card} alt="Pyament Methods" className="fz-3-payment-methods"/>
            </div>
          </div>
        </div>
      </div>
